...
export default class ChangeRelationEntryAndIncome1662086962695
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "entry" ADD CONSTRAINT "FK_702d0e9d67d9bf64001503c526a" FOREIGN KEY ("income_id") REFERENCES "income"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "entry" ADD CONSTRAINT "FK_76f7fd51c1e617299ad80212830" FOREIGN KEY ("incomeId") REFERENCES "income"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }
}
